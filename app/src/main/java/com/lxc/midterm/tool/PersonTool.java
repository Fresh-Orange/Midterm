...
public class PersonTool {
    ...
    public static void getTwentyPerson(final Integer page, final String keyword){
        // 使用okhttp
        new Thread(){
            @Override
            public void run() {
    ...
    /*音频上传目前暂未处理，填null*/
    /*返回SimpleResponse*/
    public static void addUpdatePerson(final Person person, File head_file, File audio_file){
        //上传帖子图片
    ...
    /*返回SimpleResponse*/
    public static void deletePerson(final Integer person_id){
        // 使用okhttp
        new Thread(){
            @Override
            public void run() {
    ...
    /*返回按照人气值排序的人物列表*/
    public static void getTenRankPerson(final Integer page){
        // 使用okhttp
        new Thread(){
            @Override
            public void run() {
        ...
        /*对人物点赞*/
        public static void addGood(final Integer person_id){
            // 使用okhttp
            new Thread(){
                @Override
                public void run() {
